...
void WindspeedEstimation::updateVars(uint16_t rpm, float theta, uint16_t l_current, uint16_t l_voltage, uint16_t l_power)
{
    _rpm = rpm;
    _theta = theta;
    _l_voltage = l_voltage;
    _l_current = l_current;
    _l_power = l_power;
}

double WindspeedEstimation::linear(uint16_t rpm, float theta, uint16_t l_current, uint16_t l_voltage, uint16_t l_power)
{
    updateVars(rpm, theta, l_current, l_voltage, l_power);
...
double WindspeedEstimation::secondOrder(uint16_t rpm, float theta, uint16_t l_current, uint16_t l_voltage, uint16_t l_power)
{
    updateVars(rpm, theta, l_current, l_voltage, l_power);
    return -2.2072515
            + 0.0*(1)
...
double WindspeedEstimation::bestFit(uint16_t rpm, float theta, uint16_t l_current, uint16_t l_voltage, uint16_t l_power)
{
    updateVars(rpm, theta, l_current, l_voltage, l_power);
